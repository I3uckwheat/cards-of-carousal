...
function TallyMarker({ isCzar, tallyCount }) {
  return (
    <Svg tallyCount={tallyCount} width="42" height="30" viewBox="0 0 42 30" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="ScoreTally">
        <path id="tally1" d="M32.4285 3.19775V29.5701" stroke={isCzar ? 'white' : 'black'} strokeWidth="2" />
        <path id="tally2" d="M25.4439 3.51099L23.2217 29.5966" stroke={isCzar ? 'white' : 'black'} strokeWidth="2" />
        <path id="tally3" d="M16.5548 3.51099L14.3326 29.5966" stroke={isCzar ? 'white' : 'black'} strokeWidth="2" />
        <path id="tally4" d="M7.66589 3.51099L5.44367 29.5966" stroke={isCzar ? 'white' : 'black'} strokeWidth="2" />
